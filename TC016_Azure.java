...
public class TC016_Azure {
		...
		public static void main(String[] args) throws InterruptedException, IOException {
	        ...
	        chromePrefs.put("download.default_directory", "E:\\Selenium\\90_Day_Training\\OutputFiles");
			...
			//1Go to https;//azure.microsoft.com/en-in/
			...
			WebElement region = driver.findElementByXPath("(//select[@aria-label='Region'])[1]");
			Select ddRegion = new Select(region);
			...
			WebElement memoryEle = driver.findElementByXPath("//select[@name='memory']");
			Select ddMemory = new Select(memoryEle);
			...
			File file = new File("E:\\Selenium\\90_Day_Training\\OutputFiles\\ExportedEstimate.xlsx");   
			...
			WebElement egEle = driver.findElementByXPath("//a[text()='Example Scenarios']");
			...
			WebElement ciConButton = driver.findElementByXPath("//button[@title='CI/CD for Containers']");
			...
			Select ddCurrCI = new Select(currCI);
			...
			WebElement devPricing = driver.findElementByXPath("//span[text()='Show Dev/Test Pricing']");
			...
			WebElement expEle = driver.findElementByXPath("//button[@class='calculator-button button-transparent export-button']");
